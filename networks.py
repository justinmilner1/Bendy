...
def get_graph_path(model_name):
    dyn_graph_path = {
        ...
        'openpose_quantize': '../models/graph/cmu/graph_opt_q.pb',
        'mobilenet_thin': './models/graph/mobilenet_thin/graph_opt.pb',
        'mobilenet_v2_large': '../models/graph/mobilenet_v2_large/graph_opt.pb',
        'mobilenet_v2_large_r0.5': '../models/graph/mobilenet_v2_large/graph_r0.5_opt.pb',
        'mobilenet_v2_large_quantize': '../models/graph/mobilenet_v2_large/graph_opt_q.pb',
        'mobilenet_v2_small': '../models/graph/mobilenet_v2_small/graph_opt.pb',
    }
